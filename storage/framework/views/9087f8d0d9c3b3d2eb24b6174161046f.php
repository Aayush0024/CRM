        ...
        <div class="border-t border-gray-100 p-4">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="text-xs text-gray-400 truncate"><?php echo e(auth()->user()->role->name ?? 'User'); ?></div>
                </div>
            </div>
        </div>
    </aside>
        ...
        <header class="shrink-0 bg-white shadow-sm z-20 px-4 md:px-6 py-3 flex items-center justify-between border-b border-gray-100">
            ...
            <div class="flex items-center gap-3">
                        ...
                        <div class="max-h-72 overflow-y-auto scrollbar-thin">
                            ...
                            <div class="flex items-start gap-3 px-4 py-3 hover:bg-gray-50 <?php echo e(is_null($notif->read_at) ? 'bg-indigo-50/40' : ''); ?>">
                                <div class="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center flex-shrink-0">
                                    <i class="fas fa-bell text-indigo-500 text-xs"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                ...
                <div class="relative">
                    ...
                    <div id="userMenu" class="hidden absolute right-0 mt-1 w-44 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50 fade-in">
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button class="w-full text-left flex items-center gap-3 px-4 py-2 text-sm text-red-600 hover:bg-red-50">
                                <i class="fas fa-sign-out-alt"></i> <?php echo e(__('app.nav.logout')); ?>
...
<?php /**PATH C:\Users\HP\Desktop\lp\regional-crm\resources\views/layouts/app.blade.php ENDPATH**/ ?>