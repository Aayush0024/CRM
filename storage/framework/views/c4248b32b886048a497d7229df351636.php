...
<?php $__env->startSection('title', __('app.tasks.edit')); ?>
...
<div class="py-2 max-w-2xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-bold text-gray-900"><?php echo e(__('app.tasks.edit')); ?>: <?php echo e($task->title); ?></h2>
    </div>
    <form action="<?php echo e(route('tasks.update', $task)); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2"><label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('app.tasks.title_field')); ?> <span class="text-red-500">*</span></label><input type="text" name="title" value="<?php echo e(old('title', $task->title)); ?>" required class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"></div>
                <div>
                    ...
                    <select name="type" class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <option value="<?php echo e($t); ?>" <?php echo e(old('type', $task->type) === $t ? 'selected' : ''); ?>><?php echo e(__('app.task_types.'.$t)); ?></option>
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <option value="<?php echo e($s); ?>" <?php echo e(old('status', $task->status) === $s ? 'selected' : ''); ?>><?php echo e(__('app.status.'.$s)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="priority" class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ...
                        <option value="<?php echo e($p); ?>" <?php echo e(old('priority', $task->priority) === $p ? 'selected' : ''); ?>><?php echo e(__('app.priority.'.$p)); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div><label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('app.tasks.due_date')); ?></label><input type="datetime-local" name="due_date" value="<?php echo e(old('due_date', $task->due_date?->format('Y-m-d\TH:i'))); ?>" class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"></div>
                <div>
                ...
                <div class="sm:col-span-2"><label class="block text-sm font-medium text-gray-700 mb-1"><?php echo e(__('app.tasks.description')); ?></label><textarea name="description" rows="3" class="w-full px-3 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old('description', $task->description)); ?></textarea></div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\lp\regional-crm\resources\views/tasks/edit.blade.php ENDPATH**/ ?>